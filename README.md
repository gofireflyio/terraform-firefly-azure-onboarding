...
module "firefly_azure" {
  source  = "github.com/gofireflyio/terraform-firefly-azure-onboarding?ref=v1.6.1"
  providers = {
...
module "firefly_azure" {
  source  = "github.com/gofireflyio/terraform-firefly-azure-onboarding?ref=v1.6.1/modules/single_integration"
  providers = {
    azurerm.deployment_subscription = azurerm.deployment_subscription
  }
